...
export default function ProfilePage() {
  ...
  const { data: bookings, isLoading } = trpc.booking.getUserBookings.useQuery(undefined, {
    enabled: !!user,
  })
    ...
    return (
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto text-center">
          ...
          <p className="mb-6">Please sign in to view your profile and bookings.</p>
          <Button asChild>
              ...
              {bookings.map((booking) => (
                <Card key={booking.id}>
                  <CardHeader>
                    ...
                    <CardDescription>Booked on {format(new Date(booking.createdAt), "MMMM d, yyyy")}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p>
                            {booking.accommodation === "blue-ocean" ? "Blue Ocean Lodging" : "Island Rock Lapa Houses"}
                          </p>
                        </div>
                        <div>
