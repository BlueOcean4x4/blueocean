    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
        <div className="flex flex-col gap-4 sm:gap-6">
          <div className="bg-white sticky top-0 z-40 gap-0 md:gap-2 rounded-lg shadow-md overflow-hidden">
            <h1 className="text-xl min-h-16 sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6">
              Admin Dashboard
            </h1>
            <AdminNav />
          </div>
          <main className="bg-white p-3 sm:p-6 rounded-lg shadow-md relative">
            {children}
          </main>
        </div>
      </div>
